...
namespace ScoreApp.MVC
{
    ...
    class Control
    {
        ...
        {
            model.sequence.tracks.Add(new Track());
            InitTracks();
        ...
        {
            model.sequence.tracks.RemoveAt(model.selectedTrack);
            InitTracks();
        }
        ...
        private void HandleLoadCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            model.Tempo = model.sequencer.clock.Tempo;
            InitTracks();
        }
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            if (!model.scrolling)
            {
                ...
                vue.ProgressViewerBar.SetValue( Canvas.LeftProperty, 
                    offsetForNoteAppelations + cellWidth * model.sequencer.Position / DAWhosReso );
            }
        }
